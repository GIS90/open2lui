  ...
  <div class="app-container">
    ...
    <div id="data-container" class="table-sty">
      ...
      >
        ...
        <el-table-column fixed="left" prop="title" label="标题" width="250" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
        <el-table-column prop="content" label="消息内容" width="350" sortable :header-align="tableRowAttrs.headerAlign" align="left" :show-overflow-tooltip="tableRowAttrs.sot" />
        <el-table-column prop="mass" label="是否群发" width="140" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
        <el-table-column prop="send" label="是否发送" width="140" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
    ...
    <!-- 提示说明 -->
    <message-tip :show="tipDialogStatus" @close-tip="closeTip" />

    <!-- 新增 -->
    <message-add :show="addDialogStatus" @close-add-dg="closeAddDialog" />
...
export default {
  ...
  data() {
    return {
      ...
      pageSourceId: 'notify-message', // page source id
  ...
  methods: {
    ...
    getTableList(type) { // get source list data
      ...
      return new Promise((resolve, reject) => {
        notifyMessageList(data).then(response => {
    ...
    rowDelete(index, row) {
      if (row?.md5_id) {
        ...
        this.btnDisabled = true
        return new Promise((resolve, reject) => {
          notifyMessageDelete(data).then(response => {
