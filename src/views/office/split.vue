  ...
  <div class="app-container">
    ...
    <div id="data-container" class="table-sty">
      ...
      >
        ...
        <el-table-column prop="set_sheet_name" label="拆分Sheet" width="180" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.headerAlign" :show-overflow-tooltip="tableRowAttrs.sot" />
        ...
        <el-table-column label="Sheet数" width="180" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align">
          <template slot-scope="scope">
