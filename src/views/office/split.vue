  ...
  <div class="app-container">
    ...
    <div id="data-container" class="table-sty">
      ...
      >
        ...
        <el-table-column prop="set_sheet_name" label="合并Sheet" width="280" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.headerAlign" :show-overflow-tooltip="tableRowAttrs.sot" />
        <el-table-column prop="ftypev" label="类别" width="150" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
        <el-table-column label="Sheet数" width="150" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align">
          <template slot-scope="scope">
        ...
        <el-table-column prop="numopr" label="操作次数" width="150" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
