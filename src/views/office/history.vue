  ...
  <div class="app-container">
    ...
    <div id="data-container" class="table-sty">
      ...
      >
        ...
        <el-table-column label="类别" width="140" :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align">
          <template slot-scope="scope">
            <el-tag :type="scope.row.ftypek == 1 ? 'success' : 'warning'" disable-transitions>
              {{ scope.row.ftypev }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column label="Sheet数" width="180" :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot">
          <template slot-scope="scope">
        ...
        <el-table-column prop="compress_cn" label="ZIP压缩" width="140" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
        ...
        <el-table-column prop="rtx_id" label="创建用户RTX" width="180" sortable :header-align="tableRowAttrs.headerAlign" :align="tableRowAttrs.align" :show-overflow-tooltip="tableRowAttrs.sot" />
